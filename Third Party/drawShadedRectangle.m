function hPatch = drawShadedRectangle(vecXMinMax,vecYMinMax,vecC1,vecC2,vecC3,typeHorzVert)
%MED 23 Feb 2005
%Many modified 30 Oct 2015
...
% e.g. drawShadedRectangle([0 1],[0 1],[1 1 1],[0.5 0.5 0.5],[0 0 1],'vertical'
...
if ~exist('typeHorzVert','var'), typeHorzVert = 'Horizontal';end;
